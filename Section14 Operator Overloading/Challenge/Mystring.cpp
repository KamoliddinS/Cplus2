...
bool operator==(const Mystring &obj, const Mystring &rhs){
    return (strcmp(obj.str, rhs.str) == 0);
};
bool operator!=(const Mystring &obj, const Mystring &rhs){
    return (strcmp(obj.str, rhs.str) !=0);
};
...
Mystring operator*(const Mystring &lhs, const int &n){
    char *buff= new char [n*strlen(lhs.str)+1];
//        strcpy(buff, lhs.str);
...
void Mystring::operator*=( const int &n){
